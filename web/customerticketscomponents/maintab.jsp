...
<div id="sub-cont">
	...
	<h4 style="font-weight:bold;">Book Tickets :
	  ...
	  <div id="modal1" class="modal modal-fixed-footer">
	    <div class="modal-content">
	      			...
	      			<div style="width:64%;margin:1rem auto;">
	      				...
	      				<h3 class="center-align" style="font-weight:bold;">Confirm Booking</h3>
	    ...
	    <div class="modal-footer">
	    	<a href="#!" class="modal-close modalbutton waves-effect waves-dark btn-flat red-text" id="closemodalbutton"><strong>Cancel</strong></a>
	      	<a class="modal-close modalbutton waves-effect waves-light btn grey darken-4" id="submitbutton"><strong>Proceed to Booking Seats</strong></a>
	    </div>
	  </div>
